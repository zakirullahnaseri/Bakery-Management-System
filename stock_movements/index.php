...
$totalSales = (float)($salesSummary["total_sales_amount"] ?? 0);

$totalPurchases = (float)($purchaseSummary["total_purchase_amount"] ?? 0);

$totalExpenses = (float)($expenseSummary["total_expense_amount"] ?? 0);
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <div class="report-buttons">
                ...
                <a
                    href="../stock_movements/index.php"
                    class="btn btn-outline-primary">
